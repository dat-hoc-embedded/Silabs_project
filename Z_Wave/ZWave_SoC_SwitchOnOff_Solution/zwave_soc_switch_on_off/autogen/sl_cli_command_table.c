...
static const sl_cli_command_info_t cli_cmd__toggle_led = \
  SL_CLI_COMMAND(cli_toggle_led,
                 "Toggle the LED0",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd__get_led_state = \
  SL_CLI_COMMAND(cli_get_led_state,
                 "Get LED0 state from the expansion header",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd__send_nif = \
  SL_CLI_COMMAND(cli_send_nif,
                 "Send Node Information Frame",
                  "",
                 {SL_CLI_ARG_END, });
...
const sl_cli_command_entry_t sl_cli_default_command_table[] = {
  ...
  { "toggle_led", &cli_cmd__toggle_led, false },
  { "get_led_state", &cli_cmd__get_led_state, false },
  { "send_nif", &cli_cmd__send_nif, false },
